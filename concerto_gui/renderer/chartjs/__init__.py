...
from concerto_gui import pluginmanager, version
from concerto_gui.renderer import RendererBackend
...
class ChartJSRenderer(RendererBackend):
 ...
 $LAB.script("%(chartjs_js)s").wait(function() {
    var size = concerto_gui_getRenderSize("#%(cssid)s", %(kwargs)s);
