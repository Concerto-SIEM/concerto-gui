...
function CommonListing(elem, text, options, restored_parameters) {
    ...
    var grid = concerto_gui_grid(elem, options)
    .jqGrid('navGrid', {
        add: false,
        edit: false,
        del: false,
    ...
    .jqGrid('navButtonAdd', {
        ...
        onClickButton: function() {
            concerto_gui_dialog({message: "Reset the preferences for this grid?", type: "confirm"});

            $('#concerto_gui-dialog-confirm-OK').off("click").on("click", function() {
                var params = {};
                params["jqgrid_params_" + grid.attr("id")] = "{}";
                concerto_gui_update_parameters(params).done(function() {
    ...
    grid.ajax = function(data) {
        ...
        return concerto_gui_ajax(_mergedict(data, {type: "POST"}));
    };
    ...
    $(".button-add").on("click", function() {
         ...
         */
        concerto_gui_ajax({ url: options.editLink });
    });
    ...
    $(".button-duplicate").on("click", function() {
        ...
        if ( ! row ) return;
        concerto_gui_ajax({ url: options.editLink, data: {duplicate: row} });
    });
    ...
    concerto_gui_resource_register({
        destroy: function() {
...
function saveGrid(grid) {
    ...
    concerto_gui_update_parameters(params);
}
