...
{
    var type = obj["__concerto_gui_class__"][0];
    var kwargs = obj["__concerto_gui_class__"][1];
...
{
    return (obj && typeof(obj) == "object" && obj["__concerto_gui_class__"]);
}
...
function _concerto_gui_revive(obj)
{
    if ( typeof(obj) != "object" )
        return obj;

    for ( var i in obj ) {
        var elem = _concerto_gui_revive(obj[i]);
