...
from concerto_gui.dataprovider import COMPOSITE_TIME_FIELD, Criterion, CriterionOperator
from concerto_gui.dataprovider.pathparser import _Path, SelectionObject, STRING_INDEX_REGEX
...
class CTETimeBoundsError(error.ConcertoUserError):
