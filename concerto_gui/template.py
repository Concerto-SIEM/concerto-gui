...
from concerto_gui import siteconfig
...
_MAKO_GENERIC_ARGS = {
    ...
    "input_encoding": 'utf8', "imports": [
        'from concerto_gui.utils import html, json',
        'from concerto_gui.utils.html.helpers import checked, disabled, selected, csrftoken'
    ],
...
class _ConcertoTemplate(object):
...
class _ConcertoTemplateProxy(object):
    @cache.memoize("cache")
    def __call__(self, *args):
        return _ConcertoTemplate(*args)

    @classmethod
    def __instancecheck__(cls, instance):
        return isinstance(instance, (_ConcertoTemplate, _Dataset))


ConcertoTemplate = _ConcertoTemplateProxy()
