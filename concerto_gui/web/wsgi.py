...
from concerto_gui import main, utils
from concerto_gui.web import request
...
class WSGIRequest(request.Request):
    ...
    def _wsgi_get_bytes(self, key, default=None):
        ...
        # decoded with ISO-8859-1. This is wrong for Concerto where UTF-8 is the
...
def application(environ, start_response):
    core = main.Core.from_config(environ.get("CONCERTO_CONFIG", None))
