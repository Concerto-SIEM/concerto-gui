<%! from concerto_gui.utils.html import Markup %>

<script type="text/javascript">
    $(function() {
        $('#concerto_gui-warning').modal();
    });
</script>

<div id="concerto_gui-warning" class="modal fade" role="dialog" aria-labelledby="dialogLabel" aria-hidden="true" data-backdrop="true" data-keyboard="true" tabindex="-1">
