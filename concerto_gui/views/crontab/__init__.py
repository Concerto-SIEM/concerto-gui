...
from concerto_gui import crontab, localization, resource, response, template, utils, version, view
...
class CrontabView(view.View):
    ...
    def disable(self):
        ...
        return response.ConcertoResponse({"type": "reload", "target": "view"})
    ...
    def edit(self, id=None):
        ...
        dataset = template.ConcertoTemplate(__name__, "templates/cronjob.mak").dataset()
    ...
    def list(self):
        dataset = template.ConcertoTemplate(__name__, "templates/crontab.mak").dataset()
        return dataset.render()
