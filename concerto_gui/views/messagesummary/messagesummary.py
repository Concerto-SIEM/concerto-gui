...
from concerto_gui import hookmanager, localization, resolve, resource, template, utils, view
from concerto_gui.dataprovider import Criterion
from concerto_gui.utils import html
from concerto_gui.utils.html.helpers import POPOVER_HTML
...
class MessageSummary(Table, view.View):
    ...
    view_template = template.ConcertoTemplate(__name__, 'templates/messagesummary.mak')
