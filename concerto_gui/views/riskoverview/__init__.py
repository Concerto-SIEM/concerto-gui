...
class RiskOverview(view.View):
    ...
    def _toplayout_extra_content(self):
        ...
        return resource.HTMLSource(template.ConcertoTemplate(__name__, "templates/riskoverview.mak").render())
    ...
    def riskoverview(self):
        ...
        return view.ViewResponse(template.ConcertoTemplate(__name__, "templates/table.mak").render(data=filter(None, objs.values())))
