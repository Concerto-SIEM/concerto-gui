<%!
  import itertools
  from concerto_gui import hookmanager, utils
%>
...
<form id="form_search" method="POST" action="${ utils.iri2uri(env.request.web.get_uri()) }">
  ...
  <div id="concerto_gui-view-config-datasearch" class="concerto_gui-view-config collapse">
      <div>
      ...
      <div class="panel panel-default">
        ...
        <div id="timeline" class="panel-collapse collapse ${'in' if timeline else ''}">
          <div>
            ...
            <div id="timeline_results" class="concerto_gui-resources-container"></div>
          </div>
        </div>
      </div>
    </div>
