...
function DataSearchPage(backend, criterion_config, criterion_config_default, separators, timeline_url, common_paths)
{
    ...
    function render_timeline(force) {
        ...
        concerto_gui_resource_destroy($('#timeline_results'))
    ...
    function display_popover(node, selvalue) {
        ...
        $("#PopoverOption a.groupby_search").attr("href", concerto_gui_location().href + "?groupby[]=" + selected_field);
        ...
        $.ajax({
            url: concerto_gui_location().pathname + "/ajax_infos",
            data: elem,
    ...
    page.listing = function(elem, columns, url, jqgrid_params) {
        CommonListing(elem, {}, {
            ...
            subGridRowExpanded: function(subgridDivId, rowId) {
                ...
                $.ajax({
                    url: concerto_gui_location().pathname + "/ajax_details",
                    data: elem,
    ...
    $("#main").on("datasearch:update", function() {
        concerto_gui_save_parameters($("#form_search").serializeArray());
        update_datasearch();
    });
    ...
    $("#concerto_gui-view-config-datasearch :input").on("change", function() {
        concerto_gui_update_parameters($("#form_search :input:not(.mainmenu)").serializeArray());
    });
    ...
    $("#form_search").on("submit", function(event) {
         ...
         */
        concerto_gui_save_parameters(
            $("#form_search").serializeArray(),
            concerto_gui_location().href,
            {
                "complete": function() {
    ...
    $("#form_search .datasearch-mode").on("click", function() {
        ...
        concerto_gui_update_parameters($("#form_search").serializeArray());
        reset_search();
    });
