...
from concerto_gui import hookmanager, localization, mainmenu, resource, template, utils, view, response
...
class Agents(view.View):
    ...
    def agents(self):
        ...
        return view.ViewResponse(template.ConcertoTemplate(__name__, "templates/agents.mak").render(data=analyzer_data, extra_columns=extra_columns), menu=mainmenu.HTMLMainMenu())
    ...
    def delete(self):
        ...
        return response.ConcertoRedirectResponse(url_for(".agents"))
    ...
    def analyze(self, analyzerid):
        ...
        return template.ConcertoTemplate(__name__, "templates/heartbeatanalyze.mak").render(analyzer=analyzer)
