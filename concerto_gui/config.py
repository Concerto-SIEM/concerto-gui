...
from concerto_gui import error, siteconfig


_sentinel = object()


class ConfigError(error.ConcertoUserError):
    def __init__(self, message):
        error.ConcertoUserError.__init__(self, N_("Configuration error"), message)
...
class Config(MyConfigParser):
    def __init__(self, filename=None):
        ...
        conf_filename = filename or siteconfig.conf_dir + "/concerto_gui.conf"
