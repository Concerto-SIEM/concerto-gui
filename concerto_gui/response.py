...
from concerto_gui import compat, utils
...
class ConcertoDownloadResponse(ConcertoResponse):
    """
    ...
    def __init__(self, data, filename=None, type=None, size=None, inline=False):
        ConcertoResponse.__init__(self, data)
...
class ConcertoFileResponse(ConcertoResponse):
    """
        Static File response
    """
    def __init__(self, path):
        ConcertoResponse.__init__(self)
        self._path = path
...
class ConcertoRedirectResponse(ConcertoResponse):
    """
        Redirect response
    """
    def __init__(self, location, code=302, status_text=None):
        ConcertoResponse.__init__(self, code=code, status_text=status_text)
