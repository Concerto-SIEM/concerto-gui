...
import prelude
from concerto_gui import log, utils
...
try:
    ...
    from concerto_gui.compat.babelcompat import format_timedelta as _format_timedelta
...
class TranslationProxy(object):
    def __init__(self):
        ...
        self._domains = collections.OrderedDict([("concerto_gui", pkg_resources.resource_filename(__name__, "locale"))])
